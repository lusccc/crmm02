...
python main_runner.py --root_dir ./exps --task "finetune_classification_scratch" --per_device_train_batch_size 5000 --num_train_epochs 200 --data_path "./data/cr2" --dataset_name "cr2" --dataset_split_strategy "rolling_window" --train_years "2010,2011,2012" --test_years "2013" --use_modality "num,cat" --fuse_modality "num,cat"  --save_excel_path "./excel/cr2_res_rolling_window_#2010,2011,2012#_#2013#_epoch_test.xlsx" --save_hist_eval_csv_path "./hist_csv/hist_eval_res_cr2_2013_scratch_numLayernormIndpFeatLayerEmb_jointDrp.2AddClsToken_bertcnf256-4-4-1024-vocabsize_fixWrongPadId.csv"


python main_runner.py --root_dir ./exps --task "multi_task_classification" --per_device_train_batch_size 144 --num_train_epochs 150 --data_path "./data/cr2" --dataset_name "cr2" --dataset_split_strategy "rolling_window" --train_years "2010,2011,2012" --test_years "2013" --freeze_language_model_params True --use_modality "num,cat,text" --fuse_modality "num,cat" --contrastive_targets "joint,text" --language_model_name "mrm8488/distilroberta-finetuned-financial-news-sentiment-analysis" --load_hf_model_from_cache True --save_excel_path "./excel/cr2_res_rolling_window_#2010,2011,2012#_#2013#_1226.xlsx" --save_hist_eval_csv_path "./hist_csv/hist_eval_res_cr2_2013_multitask_numLayernormIndpFeatLayerEmb_jointDrp.2AddClsToken_bertcnf512-12-8-2048-vocabsize_fixWrongPadId_clncpWeightedEnsemble.csv"
